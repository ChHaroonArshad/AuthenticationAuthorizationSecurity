...
const SellerArtworks = () => {
    ...
    const statusColor = (s) => {
        ...
        if (s === "draft")        return { bg: "#f5f5f3", color: "#888",    border: "#e5e5e5" };
        return                           { bg: "#fef3c7", color: "#92400e", border: "#fde68a" }; // premium
    };
    ...
    const stats = {
        ...
        premium:   artworks.filter(a => a.category === "premium").length,
    };
        ...
        <div style={pg}>
            ...
            <div style={container}>
                ...
                <div style={statsRow}>
                    ...
                    <StatPill label="Premium" value={stats.premium}  color="#92400e" />
                </div>
                                            ...
                                            <td style={td}>
                                                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p style={{ margin: 0, fontSize: "12px", color: "#888", maxWidth: "200px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                                            {a.description}
                                                        </p>
                                                    </div>
                                                </div>
...
const StatPill = ({ label, value, color }) => (
    <div style={{ background: "white", border: "1px solid #ebebeb", borderRadius: "12px", padding: "16px 20px", textAlign: "center", minWidth: "100px" }}>
        <p style={{ margin: 0, fontSize: "11px", color: "#888", fontWeight: 700, letterSpacing: "1px" }}>{label}</p>
