            ...
            <div style={container}>
                ...
                {loading ? (
                    ...
                    <div style={emptyState}>
                        ...
                        <p style={{ color: "#888", fontSize: "14px" }}>Try a different category or search term.</p>
                    </div>
                ) : (
                    <div style={grid}>
                        {artworks.map(artwork => (
                            <div key={artwork._id} style={{
                                ...card,
                                ...
                                <div style={cardBody}>
                                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                                        ...
                                        <span style={{ fontSize: "11px", color: "#bbb" }}>👁 {artwork.views}</span>
                                    </div>
